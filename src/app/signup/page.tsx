        ...
        <div className="glass-panel rounded-3xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full flex items-center justify-center mt-6 px-4 py-3 border border-transparent rounded-xl text-sm font-bold text-white bg-gradient-premium hover:opacity-95 focus:outline-none transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed group cursor-pointer"
            >
              {isPending ? (
